...
class Asset:
    ...
    def __post_init__(self):
        ...
        Ensures id, symbol, and name are non-empty strings; price is greater than
        or equal to zero; market_cap, if provided, is greater than or equal to
        zero; and currency is a three-letter ISO code (letters only,
        case-insensitive).
