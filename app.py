...
class FinancialAssetApp:
    ...
    @staticmethod
    def update_asset_info(selected_asset: Optional[str], graph: AssetRelationshipGraph) -> Tuple[
        ...
        if strongest_correlations:
            ...
            for item in strongest_correlations:
                ...
                if pair is None or correlation is None:
                    continue
                summary_lines.append(f"- **{pair}**: correlation={correlation:.3f}, strength={strength}")
